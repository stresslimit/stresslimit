...
// ************************
// [wes] : why not just use "get_post_custom" ...??
// ************************
...
// ************************
// [wes] : move this into helpers.php ?
// ************************
...
function sld_admin_styles() { ?>
	...
	#login h1 a { background:url('<?php echo get_bloginfo( 'template_url' ) ?>/images/logos/admin.png') left top no-repeat; height:20px; margin-left:35px; background-size:auto; }
